...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (indexPath.row) {
        ...
        case 1:
            ...
            cell.detailTextLabel.text = [NSString stringWithFormat:@"$%@", self.itemObject.price];
            break;
        case 2:
        ...
        case 3:
            ...
            cell.detailTextLabel.text = [NSString stringWithFormat:@"%@ months", self.itemObject.warranty];
            break;
        case 4:
